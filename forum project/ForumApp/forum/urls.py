...
from .views import index, BoardView,  PostListView, TopicCreateView, NewsList, FeaturedTopic, SectionTopic, TopicDeleteView, PostUpdateView, PostCreateView, PostDeleteView, search, like_dislike_post, share_unshare_post, reply_topic, follow_unfollow_topic, delete_file,delete_post, follow_unfollow_board, quote_post, followed_boards, followed_topics, new_posts, reply_post, RecentPostList, trending, following_people_post, ReportInnapropiatePost, mentions, feed
...
urlpatterns = [
    ...
    path('create-topic/<int:board_pk>', TopicCreateView.as_view(), name='create_topic'),
    ...
    path('posts/<slug:slug>/<int:topic_pk>/', PostListView.as_view(), name='thread_post_list'),
...
#     path('delete_post/<int:pk>', PostDeleteView.as_view(), name='delete_post'),
    ...
    path('quote-post/<int:post_id>', quote_post, name='quote_post'),

    path('report/<int:post_id>', ReportInnapropiatePost, name='report_post'),

    path('news-feed/', following_people_post, name='shared_with_me'),
    path('delete-file/<int:pk>', delete_file, name='delete_file'),
    path('delete_post/<int:post_id>', delete_post, name='delete_post'),
    path('follow-topic/<int:topic_id>', follow_unfollow_topic,
    ...
    path('new-topics', new_posts, name='new'),
